 ...
 * This file demonstrates how to integrate Runeprime with a web frontend
 */

// For React/Vue/Angular applications
export class RuneprimeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RuneprimeClient(provider, contractAddress);
